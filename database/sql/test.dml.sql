...
insert into products (reference, name, description, merchant_id) values
    ...
    ('CD345678', 'Robe été', 'Robe légère et fluide parfaite pour les chaudes journées estivales', 3),
    ('CD456789', 'Ordinateur portable - Lenovo ThinkPad', 'Ordinateur portable puissant et fiable pour un usage professionnel', 4),
    ('CD567890', 'Chaussures de course - Nike Air Zoom Pegasus', 'Chaussures de course légères et amorties pour une course confortable', 5),
    ('CD678901', 'Roman - Harry Potter à école des sorciers', 'Premier livre de la série Harry Potter écrit par J.K. Rowling', 6),
    ('CD789012', 'Téléviseur - Samsung 4K UHD', 'Téléviseur haute définition avec une qualité image exceptionnelle', 7),
    ('CD890123', 'Jeans - Levis 501', 'Jeans emblématiques de Levis avec un ajustement classique et confortable', 8),
    ('CD901234', 'Fruits de saison - Pommes Granny Smith', 'Délicieuses pommes croquantes et juteuses pour une collation saine', 9),
    ('CD012345', 'Montre - Rolex Submariner', 'Montre de plongée de luxe avec un design emblématique et des caractéristiques exceptionnelles', 10);
